    ...
    rules: [
      ...
      },
      {
        ...
        use: {
          ...
          options: {
            // env: es6 to es5
            presets: ['@babel/preset-env', '@babel/preset-react'], // npm install --save-dev @babel/preset-env @babel/preset-react
            plugins: ['@babel/plugin-transform-runtime'] // npm install --save-dev @babel/plugin-transform-runtime
          }
        }
      }
    ]
